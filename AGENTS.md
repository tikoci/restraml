...
- **`docs-index.json`** — published JSON inventory of root docs assets and per-version files; generated by workflows and used for static version discovery on GitHub Pages
